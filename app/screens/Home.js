      ...
      <View style={{ alignItems: "center" }}>
        <View style={{ marginHorizontal: 20 }}>
          ...
          <View style={{ flexDirection: "row", marginBottom: 10 }}>
            ...
            >
              <Text style={{ color: "rgb(255,40,45)" }}>All</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                padding: 10,
            ...
            >
              <Text style={{ color: "rgba(0,0,0,0.8)" }}>Classic</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                padding: 10,
            ...
            >
              <Text style={{ color: "rgba(0,0,0,0.8)" }}>Sports</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                padding: 10,
            ...
            >
              <Text style={{ color: "rgba(0,0,0,0.8)" }}>Outdoor</Text>
            </TouchableOpacity>
          </View>
          <ScrollView>
            <View style={{ alignItems: "center" }}>
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  ...
                  >
                    ...
                    ></Image>
                    <View style={{ alignItems: "center" }}>
                      <Text style={{ color: "rgba(0,0,0,0.4)" }}>Classic</Text>
                ...
                >
                  ...
                  >
                    ...
                    ></Image>
                    <View style={{ alignItems: "center" }}>
                      <Text style={{ color: "rgba(0,0,0,0.4)" }}>Sweet</Text>
                      <Text style={{ color: "rgb(255,40,45)" }}>
                        $
                        <Text style={{ color: "black", fontWeight: "600" }}>
                          1,000.00
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  ...
                  >
                    ...
                    ></Image>
                    <View style={{ alignItems: "center" }}>
                      <Text style={{ color: "rgba(0,0,0,0.4)" }}>Outdoor</Text>
                      <Text style={{ color: "rgb(255,40,45)" }}>
                        $
                        <Text style={{ color: "black", fontWeight: "600" }}>
                          500.00
                ...
                >
                  ...
                  >
                    ...
                    ></Image>
                    <View style={{ alignItems: "center" }}>
                      <Text style={{ color: "rgba(0,0,0,0.4)" }}>Sports</Text>
                      <Text style={{ color: "rgb(255,40,45)" }}>
                        $
                        <Text style={{ color: "black", fontWeight: "600" }}>
                          600.00
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  ...
                  >
                    ...
                    ></Image>
                    <View style={{ alignItems: "center" }}>
                      <Text style={{ color: "rgba(0,0,0,0.4)" }}>Outing</Text>
                      <Text style={{ color: "rgb(255,40,45)" }}>
                        $
                        <Text style={{ color: "black", fontWeight: "600" }}>
                          700.00
