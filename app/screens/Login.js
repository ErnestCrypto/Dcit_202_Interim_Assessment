...
export default function Login({navigation}){
    ...
    return (
        ...
        <View style={{flex: 1, alignItems:"center",backgroundColor:"white"}}>
            ...
            <Text style={{color:'black',fontSize:30,fontWeight:'600',marginBottom:20}}>
                TAGLINE
            </Text>
...
/>
    ...
    <Text style={{fontSize:'17',fontWeight:"700",color:"white",}}>
            ...
            <TouchableOpacity>
            <Text 
            style={{marginTop:10,fontWeight:"500",color:"gray"}}
            >
                Not a member? 
                <Text 
                style={{color:"rgb(255,40,45)",fontWeight:"bold"}}>
                    Signup</Text>
            </Text>
            </TouchableOpacity>
    </View> 
