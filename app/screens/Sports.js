...
<View style ={{alignItems:"center"}}>
    ...
    <View style={{ 
        ...
        source="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvhA_3F0doMXKHbib_J5UNcqpzT7yW9fdwDA&usqp=CAU"
        ></Image>
        <View style={{alignItems:"center"}}>
        <Text style={{color:"rgba(0,0,0,0.4)"}}>
        Sports
...
<Image
        ...
        source="https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/a529869e-e0f3-4b7a-885f-9f2d0b8481b8/mercurial-superfly-8-academy-mg-multi-ground-soccer-cleat-pbJFG6.png"
        ></Image>
        <View style={{alignItems:"center"}}>
        <Text style={{color:"rgba(0,0,0,0.4)"}}>
        Outing
